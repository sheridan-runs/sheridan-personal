...
export const financeDraft = {
  ...
  publishDate: "2026-05-15", // Placeholder date
  category: "Finance",
  content: `
...
export const brandDraft = {
  ...
  publishDate: "2026-02-05", // Placeholder date
  category: "Design",
  content: `
      <p class="text-xl text-slate-300 leading-relaxed mb-8">
...
// If you have an existing array exporting articles, you can add them like this:
// export const articles = [financeDraft, brandDraft];
